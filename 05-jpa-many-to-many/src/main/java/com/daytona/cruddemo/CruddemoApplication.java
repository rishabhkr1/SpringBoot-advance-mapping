...
import com.daytona.cruddemo.entity.*;
...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		Course tempCourse1=new Course("Become a Game Developer");
		Course tempCourse2=new Course("Master Rubik's Cube");
	...
	private void createCourseAndStudent(AppDAO appDAO) {
		//create the course
		Course tempCourse=new Course("let's learn to play guitar");

		//create the students
		Student tempStudent1=new Student("Amit","kumar","amit@mail.com");
		Student tempStudent2=new Student("Aman","Singh","Aman@mail.com");
